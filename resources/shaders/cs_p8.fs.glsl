...
void main(void) {
    ...
    layer_color = mix(layer_color, vec4(0, 0, 0, 0), vec4(vLayerValues1.z > 0.0));

    layer_color = mix(layer_color, prim_colors[7], prim_colors[7].a);
    result = mix(result, layer_color, layer_color.a * vLayerValues1.w);
