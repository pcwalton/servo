...
pub fn process_content_box_request<N: LayoutNode>(_: N) -> Option<Rect<Au>> {
    None
}

pub fn process_content_boxes_request<N: LayoutNode>(_: N) -> Vec<Rect<Au>> {
    vec![]
}

pub fn process_node_geometry_request<N: LayoutNode>(_: N) -> Rect<i32> {
    Rect::zero()
}
...
pub fn process_node_scroll_area_request<N: LayoutNode>(_: N) -> Rect<i32> {
    Rect::zero()
}
...
pub fn process_offset_parent_query<N: LayoutNode>(_: N) -> OffsetParentResponse {
    OffsetParentResponse::empty()
}

pub fn process_style_query<N: LayoutNode>(_: N) -> StyleResponse {
    StyleResponse(None)
}
