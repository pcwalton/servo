...
#[derive(Clone, Debug, Copy, RustcDecodable, RustcEncodable)]
struct GlyphEntry {
    value: u32,
}
...
#[derive(PartialEq, Clone, Eq, Debug, Copy, RustcDecodable, RustcEncodable)]
...
int_range_index! {
    #[derive(RustcEncodable, RustcDecodable, HeapSizeOf)]
